...
const Nav = () => {
  ...
  <div className="flex-1">
    <Link className="btn btn-ghost gap-0 text-secondary normal-case text-2xl">Cyber<span className="text-primary">Spark</span></Link>
    {/* <a className="btn btn-ghost gap-0 text-secondary normal-case text-2xl">Cyber<span className="text-primary">Spark</span></a> */}
  </div>
